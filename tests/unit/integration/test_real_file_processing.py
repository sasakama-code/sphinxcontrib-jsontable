...
class TestRealFileProcessing:
    ...
    def create_large_excel_file(self, filename: str = "large_test.xlsx", rows: int = 5000) -> str:
        """大容量Excelファイルを作成.
    ...
    def test_memory_usage_monitoring(self):
        ...
        # メモリ使用量確認（200MB以内の増加）
        assert memory_increase < 200, f"メモリ使用量増加が大きすぎます: {memory_increase:.1f}MB"
    ...
    def test_concurrent_file_processing(self):
        ...
        def process_file(file_path, file_index):
            try:
                ...
                results_queue.put((file_index, result["success"], len(result.get("data", []))))
    ...
    def test_real_world_scenario_simulation(self):
        ...
        business_data = [
            ...
            ["T001", "株式会社ABC", "製品A", "10", "5000", "50000", "2023-01-15", "田中"],
            ["T002", "XYZ商事", "製品B", "5", "8000", "40000", "2023-01-16", "佐藤"],
            ["T003", "DEF工業", "製品C", "20", "3000", "60000", "2023-01-17", "鈴木"],
            ["T004", "GHI株式会社", "製品A", "15", "5000", "75000", "2023-01-18", "田中"],
