...
class TestConversionResult:
    ...
    def test_empty_data_conversion(self):
        ...
        result = ConversionResult(data=[], has_header=False, headers=[], metadata={})
...
class TestDataFrameConversion:
    ...
    def test_simple_dataframe_conversion(self):
        ...
        result = self.converter.convert_dataframe_to_json(
            self.simple_df, has_header=True
        )
    ...
    def test_no_header_conversion(self):
        ...
        result = self.converter.convert_dataframe_to_json(
            self.simple_df, has_header=False
        )
...
class TestHeaderDetection:
    ...
    def setup_method(self):
        ...
        self.no_header_df = pd.DataFrame([[1, 2, 3], [4, 5, 6], [7, 8, 9]])
...
class TestMockDataConverter:
    ...
    def test_custom_mock_results(self):
        ...
        custom_header = HeaderDetectionResult(
            has_header=False, confidence=0.3, headers=[], analysis={"custom": True}
        )
...
class TestInterface:
    ...
    def test_interface_compliance(self):
        ...
        converters = [DataConverter(), MockDataConverter()]
    ...
    def test_polymorphic_usage(self):
        ...
        def process_data(
            converter: IDataConverter, df: pd.DataFrame
        ) -> ConversionResult:
