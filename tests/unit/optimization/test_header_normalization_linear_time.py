...
class TestHeaderNormalizationLinearTime:
    ...
    def _create_sample_excel_file(self) -> Path:
        ...
        data = {
            ...
            'ID': ['ID_Dup1', 'ID_Dup2', 'ID_Dup3', 'ID_Dup4', 'ID_Dup5'],  # 重複ヘッダー
            'Category': ['A', 'B', 'A', 'C', 'B']
        }
    ...
    def test_duplicate_header_detection_optimization(self):
        ...
        print(f"Speed improvement: {optimization_metrics.processing_speed_improvement:.1%}")
    ...
    def test_single_pass_header_processing_integration(self):
        ...
        print(f"Duplicate operations eliminated: {duplication_elimination.duplicate_operations_eliminated}")
        print(f"Processing time reduction: {performance_improvement.processing_time_reduction:.1%}")
    ...
    def test_large_header_dataset_linear_scalability(self):
        ...
        print(f"Linear scalability confirmed: {scalability_test.linear_scalability_confirmed}")
