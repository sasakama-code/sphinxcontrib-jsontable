...
class TestUnifiedPipelineThreeStages:
    ...
    def test_unified_pipeline_three_stage_basic_processing(self):
        ...
        print(f"Efficiency improvement: {perf_metrics['efficiency_improvement_ratio']:.1f}x")
    ...
    def test_unified_pipeline_stage_two_data_transformation(self):
        ...
        stage_result = unified_pipeline.execute_stage_two_data_transformation(
            stage_one_result=mock_stage_one_result,
            processing_options=stage_two_options
        )
    ...
    def test_unified_pipeline_error_handling_integration(self):
        ...
        for _i, scenario in enumerate(error_scenarios):
            ...
            assert error_info['error_stage_detected'] in ['stage_1', 'stage_2', 'stage_3']
            ...
            assert any(attempt['stage'] == error_info['error_stage_detected'] for attempt in recovery_info)
    ...
    def test_unified_pipeline_backward_compatibility(self):
        ...
        assert 'header_row' in result if legacy_options.get('header_row') is not None else True
