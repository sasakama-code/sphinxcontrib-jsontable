...
def test_excel_support():
    ...
    try:
        ...
        try:
            ...
            assert loader.SUPPORTED_EXTENSIONS == {'.xlsx', '.xls'}
        finally:
...
def test_excel_directive_import():
    ...
    try:
        from sphinxcontrib.jsontable.directives import JsonTableDirective, EXCEL_SUPPORT
...
def test_excel_file_detection():
    ...
    for filename, expected in test_cases:
        ...
        assert is_excel == expected, f"Failed for {filename}: expected {expected}, got {is_excel}"
...
def test_dependency_availability():
    ...
    print(f"✓ 基本依存関係: json, pathlib, typing")
