...
class TestFinal80Coverage:
    ...
    def test_dangerous_protocol_detection_365_395(self):
        ...
        try:
            ...
            security_indicators = [
                ...
                "file://", "javascript", "vbscript", "ftp://", "ldap://"
            ]
            ...
            try:
                ...
                if warning_list:
                    ...
                    security_warnings = [
                        ...
                        if any(kw in msg for kw in ["security", "dangerous", "external"])
                    ]
                    # セキュリティ警告の存在確認
    ...
    def test_hyperlink_cell_iteration_coverage(self):
        ...
        try:
            ...
            # セキュリティエラーが発生した場合
            error_msg = str(e).lower()
            assert "dangerous" in error_msg or "security" in error_msg or "external" in error_msg
    ...
    def test_multiple_sheets_security_validation(self):
        ...
        try:
            ...
            error_msg = str(e).lower()
            assert any(kw in error_msg for kw in ["dangerous", "security", "external", "links"])
    ...
    def test_edge_case_security_patterns(self):
        ...
        try:
            ...
            error_msg = str(e).lower()
            expected_keywords = ["dangerous", "security", "external", "links", "detected"]
