...
class TestRangeSpecification:
    ...
    def test_invalid_range_format_error(self):
        ...
        for invalid_range in invalid_ranges:
            with pytest.raises(ValueError, match="Invalid range format"):
                self.loader.load_from_excel_with_range(excel_path, range_spec=invalid_range)
    ...
    def test_inverted_range_error(self):
        ...
        # 逆転した範囲（C3:A1は無効）
        with pytest.raises(ValueError, match="Invalid range: end cell must be after start cell"):
