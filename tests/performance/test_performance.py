...
class TestPerformanceLimits:
    ...
    def test_metadata_extraction_benchmark(self, benchmark):
        ...
        def extract_metadata():
            return self.metadata_extractor.extract_metadata(test_data)
    ...
    def test_memory_usage_limits(self):
        ...
        for size in sizes:
            ...
            for i in range(size):
                large_data.append({
                    "id": i,
                    "data": f"Content_{i}" * 10,  # Some content to increase memory usage
                    "value": i * 2.5,
...
class TestPerformanceIntegration:
    ...
    def test_end_to_end_performance(self):
        ...
        # 4. Extract metadata
        metadata = self.metadata_extractor.extract_metadata(loaded_data)
    ...
    def test_memory_efficiency(self):
        ...
        for iteration in range(10):
            ...
            table = self.table_builder.build(converted, has_header=True)
            metadata = self.metadata_extractor.extract_metadata(test_data)
    ...
    def test_table_building_benchmark(self, benchmark):
        ...
        headers = ["ID", "Name", "Category", "Value", "Description"]
        rows = []
