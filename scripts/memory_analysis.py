...
def analyze_memory_usage():
    ...
    print("   • String conversion overhead: ~2x original size")
    print("   • Table structure overhead: ~1.5x converted size")
    print("   • Total conversion overhead: ~3x original data size")
...
def analyze_performance_bottlenecks():
    ...
    print("\n💡 KEY FINDINGS:")
    print("   • Only _extract_headers has built-in limits")
    print("   • Table conversion and building have no limits")
    print("   • Memory usage scales linearly with data size")
    print("   • String conversion creates additional memory overhead")
