...
class SinglePassHeaderResult:
    ...
    performance_metrics: HeaderProcessingMetrics = field(default_factory=HeaderProcessingMetrics)
...
class OptimizedHeaderProcessor:
    ...
    def execute_single_pass_header_processing(
        ...
        try:
            ...
            sample_headers = ['employee_id', 'full_name', 'department_name', 'hire_date', 'annual_salary']
            sample_data = [
            ...
            if enable_header_normalization:
                normalized_headers = self._execute_integrated_header_normalization_internal(sample_headers)
            else:
            ...
            return SinglePassHeaderResult(
                success=False,
                performance_metrics=HeaderProcessingMetrics()
            )
    ...
    def execute_integrated_header_normalization(
        ...
        # 問題ヘッダーのサンプル処理
        problematic_headers = ['', 'Name', 'Name ', 'Department/Team', 'Annual Salary ($)']
    ...
    def process_excel_file(
        ...
        if self.enable_header_optimization and self.header_processor:
            ...
            result = {
                ...
                'rows': len(header_result.processed_data) if header_result.processed_data else 0,
